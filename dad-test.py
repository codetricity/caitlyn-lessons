...
firstMusic = pygame.mixer.Sound("snd/safari.wav")
secondMusic = pygame.mixer.Sound("snd/oceanwaves.wav")
yummySound = pygame.mixer.Sound("snd/yummy.wav")
...
while gameon:
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if level == 100:
                ...
                if playagainrect.collidepoint(mousepos):
                    ...
                    fruitnum = fruitnumstart
                    friendnum = friendnumstart
                    # reset original position of puffer and sharky
                    # if you don't reset the position, the shark and puffer 
                    # will be over each other and the game will end.
    ...
    if level == 2:
        ...
        if pufferrect.colliderect(sharkrect) and level == 2:
            screen.fill(pink)
            direction = "stop"
            gameoversurface = fonts.render("Game Over", False, white)
            screen.blit(gameoversurface, (350, 302))
